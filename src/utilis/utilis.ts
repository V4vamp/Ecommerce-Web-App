...
export const registerBuyerSchema = Joi.object().keys({
    email: Joi.string().trim().lowercase().required(),
    fullName: Joi.string().required(),
    gender: Joi.string().required(),
    phone: Joi.string().required(),
...
export const registerSellerSchema = Joi.object().keys({
    email: Joi.string().trim().lowercase().required(),
    fullName: Joi.string().required(),
    gender: Joi.string().required(),
    phone: Joi.string().required(),
...
export const loginBuyerSchema = Joi.object().keys({
    email: Joi.string().trim().lowercase().required(),
    password: Joi.string().regex(/^[a-zA-Z0-9]{8,30}$/).required()
});


export const loginSellerSchema = Joi.object().keys({
    email: Joi.string().trim().lowercase().required(),
    password: Joi.string().regex(/^[a-zA-Z0-9]{8,30}$/).required()
});


export const loginAdminSchema = Joi.object().keys({
    email: Joi.string().trim().lowercase().required(),
    password: Joi.string().regex(/^[a-zA-Z0-9]{8,30}$/).required()
});
